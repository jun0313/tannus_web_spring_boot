...
import Tannus.Kim.tannus_spring.service.PostService;
...
public class PostController {
    ...
    // PostService 주입되기전 시점에서 사용하게 되면 NPE이 발생할 수도 있다.
    // 예를 들어서 생성자에서 바로 쓴다거나 아니면 서비스 레포지토리 어노테이션을 안붙였거나
//  private final PostService postService;

    // Inversion Of Control  >> 제어의 역전
    // 객체 생성과 제어의 주도권을 개발자가 아닌, 스프링부트가 갖는것
    // ioc container >> 스프링부트가 만든 개체들을 담아두고 관리하는 창고
    // 필요한 곳이 있으면 꺼내서  넣어줌
    // ioc 컨테이너에서 해당 객체를 찾아서 자동으로 넣어주니깐 우리는 new할 필요가 없다.
